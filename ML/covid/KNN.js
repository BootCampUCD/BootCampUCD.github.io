...
let knn;
const csvFilePath = 'data1.csv'; // Data
const names = ['state', 'fips', 'county', 'pop', 'confirmed_case', 'median_household_income', 'confirmed_deaths', 'cases_per_100k', 'deaths_per_100k', 'unemployment_rate', 'poverty_rate', 'white', 'black', 'native', 'asian', 'hispanic', 'dropout', 'highschool', 'some_college_associate', 'bachelor' ]; // For header
